 ...
 */
export function hideResult(root: Document | ShadowRoot): void {
  const overlay = root.getElementById('result-overlay')!;
 ...
 */
export function initRemeasureButton(onRemeasure: () => void, root: Document | ShadowRoot): void {
