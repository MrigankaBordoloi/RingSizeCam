 ...
 */
function buildEuDefaultTable(): SizeTableEntry[] {
 ...
 */
function buildUkDefaultTable(): SizeTableEntry[] {
...
const registry = new Map<string, SizeTableEntry[]>([
...
export function registerSizeChart(id: string, table: SizeTableEntry[]): void {
  registry.set(id, table);
}

/** Look up a size chart by id. Unknown ids warn and fall back to 'us-default'. */
export function getSizeChart(id: string): SizeTableEntry[] {
