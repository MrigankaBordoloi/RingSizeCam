 ...
 */
export function computeScale(coinPixelDiameter, coinRealDiameterMm) {
 ...
 */
export function computeScaleFromCard(corners, realWidthMm, realHeightMm) {
    if (realWidthMm <= 0 || realHeightMm <= 0) {
        throw new Error(`Card dimensions must be positive: ${realWidthMm} × ${realHeightMm}`);
    }
